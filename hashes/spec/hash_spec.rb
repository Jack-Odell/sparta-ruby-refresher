...
describe 'Create tests for a hash' do
  ...
  it 'avocados should have calories from fat greatter than 20' do
  ...
  it 'plums and apples should get no calories from fat' do
    expect(small_fruit_nutrition_details[:apple][:calories_from_fat] && small_fruit_nutrition_details[:plums][:calories_from_fat]).to eq(0)
  end
